...
const approveWithRejectedFields = {
...
export const tutorApprovalMessages = {
    ...
    approveWithRejectedSubject: `${approveForm.INTRO} <br/> <br/> ${approveWithRejectedFields.REJECTED_SUBJECT} <br/> <br/> ${approveForm.ENDING}`,
    approveWithRejectedDescription: `${approveForm.INTRO} <br/> <br/> ${approveWithRejectedFields.REJECTED_DESCRIPTION} <br/> <br/> ${approveForm.ENDING}`,
    approveWithRejectedDocument: `${approveForm.INTRO} <br/> <br/> ${approveWithRejectedFields.REJECTED_DOCUMENT} <br/> <br/> ${approveForm.ENDING}`,
    approveWithRejectedFields: `${approveForm.INTRO} <br/> <br/> ${approveWithRejectedFields.REJECTED_FIELDS} <br/> <br/> ${approveForm.ENDING}`,
    approveWithMissingDescription: `${approveForm.INTRO} <br/> <br/> ${approveWithRejectedFields.MISSING_DESCIPRITON} <br/> <br/> ${approveForm.ENDING}`
}
